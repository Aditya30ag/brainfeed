  ...
  useEffect(() => {
    if (article) {
      ...
      setSEO(
        ...
        article.excerpt,
        article.coverImage,
        `https://brainfeed.app/article/${article.slug}`
      );
      setCanonical(`https://brainfeed.app/article/${article.slug}`);
              ...
              <div className="lg:col-span-8">
                ...
                {article.tags && article.tags.length > 0 && (
                  <div className="mt-12 pt-8 border-t border-slate-200">
                    <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wide mb-4">Tags</h3>
                    <div className="flex flex-wrap gap-2">
                      {article.tags.map((tag) => (
                        <span key={tag} className="px-3 py-1 bg-slate-100 text-slate-700 text-sm font-semibold">
                          {tag}
                        </span>
                      ))}
                    </div>
